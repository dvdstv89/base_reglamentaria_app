...
namespace BRapp.UIControlers.CardUCController
{
    internal class DepartamentoUCController : BaseUCController<DepartamentoCard, Departamento>, ICard
    {
        ...
        public override void setInfo()
        {
            ...
            card.labelName.Text = objeto.Name + " ("+objeto.CantidadTrabajadores+")";
            card.btnList.Visible= objeto.TipoGrupoDocumentacion.Count > 0 || !visorDocumentacionUIController.IsEmptyRtf(objeto.Descripcion);           
        }        
