...
namespace BRapp.Model
{
    public class Contrato : Papel
    {
        ...
        public Contrato(PapelDto papel, ArchivoPDF ArchivoPDF, ContratoDto contratoDto, PersonaJuridica Cliente, PersonaJuridica Responsable, TipoDocumentacion TipoDocumentacion, Contrato ContratoPadre = null)
